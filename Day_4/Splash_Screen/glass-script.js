...
setTimeout(() => {
	...
	$('<a class="btn" href="../blog-deep/index.html"><span>Explore</span></a>').hide().appendTo('.footerDiv').fadeIn(2000);
},9000)


    setTimeout(function () {
        $('.waves').hide();
        $('#glass2').html('<div class="waves1 blue"></div>');
         $('#glass2').html('<div class="waves2 blue"></div>');
         $('#glass2').html('<div class="waves3 blue"></div>');
	...
	setTimeout(function () {
		$('<div id="image"></div>').hide().appendTo('.box').fadeIn(4000);
    ...
    setTimeout(
        function() 
        {
          $('#glass1').css('animation','glasskey 2s linear infinite');
          
          
          $('#glass1').css('-webkit-animation','glasskey 2s');
          $('#glass1').css('-webkit-animation-fill-mode','forwards');
          $('#glass1').css('animation-fill-mode','forwards');

          $('#glass2').css('animation','glasskey2 2s linear infinite');
          
          
          $('#glass2').css('-webkit-animation','glasskey2 2s');
          $('#glass2').css('-webkit-animation-fill-mode','forwards');
          $('#glass2').css('animation-fill-mode','forwards');
        ...
        var waterfallCanvas = function(c, cw, ch){
			...
			this.Particle.prototype.render = function(){			
                ...
                _this.ctx.strokeStyle = 'rgba(10,0,255,0.5)'
				_this.ctx.beginPath();
			...
			this.Particle.prototype.renderBubble = function(){				
                ...
                // _this.ctx.fillStyle = 'rgba(255,0,255,0.5)'
				_this.ctx.beginPath();
			...
			this.clearCanvas = function(){				
    			...
    			this.ctx.fillStyle = 'rgba(255,0,255,.06)';
